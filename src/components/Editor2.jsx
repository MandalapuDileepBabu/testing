        ...
        <div className="editor-form-content">
            ...
            <div className="form-section">
                ...
                <div className="input-field">
                    ...
                    <input type="color" name="accentColorDark" value={formData.accentColorDark || '#00eaff'} onChange={handleChange} style={{ height: '50px', padding: '5px' }} />
                </div>
                <div className="input-field">
                    <label>Background Color (Dark Mode)</label>
                    <input type="color" name="backgroundColorDark" value={formData.backgroundColorDark || '#0d0f11'} onChange={handleChange} style={{ height: '50px', padding: '5px' }} />
                </div>
                ...
                <div className="input-field">
                    ...
                    <input type="color" name="accentColorLight" value={formData.accentColorLight || '#0096c7'} onChange={handleChange} style={{ height: '50px', padding: '5px' }} />
                </div>
                <div className="input-field">
                    <label>Background Color (Light Mode)</label>
                    <input type="color" name="backgroundColorLight" value={formData.backgroundColorLight || '#f7fbfd'} onChange={handleChange} style={{ height: '50px', padding: '5px' }} />
                </div>
            </div>
            ...
            {/* Typing Headings */}
            <div className="form-section">
                <h3>Typing Headings</h3>
                <p style={{ fontSize: '11px', color: '#888', marginBottom: '10px' }}>
                    Add multiple headlines for the typing animation on the hero section.
                </p>
                <div className="list-editor">
                    {formData.typingRoles?.map((role, index) => (
                        <div key={index} className="list-item">
                            <input
                                type="text"
                                value={role}
                                onChange={(e) => updateListItem('typingRoles', index, e.target.value)}
                                placeholder="Full-Stack Developer"
                            />
                            <button className="remove-btn" onClick={() => removeListItem('typingRoles', index)}>×</button>
                        </div>
                    ))}
                    <button className="add-btn" onClick={() => addListItem('typingRoles', '')}>+ Add Headline</button>
                </div>
            </div>
